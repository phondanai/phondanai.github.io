...
var o12551 = temp__5802__auto__;
var temp__5802__auto____$1 = (o12551["core"]);
if(cljs.core.truth_(temp__5802__auto____$1)){
var o12552 = temp__5802__auto____$1;
return (o12552["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__12307__auto__ = f;
return (o__12307__auto__["toString"]).call(o__12307__auto__);
} else {
return "";
}
}catch (e12556){var _ = e12556;
return "";
}});
...
try{var o__12307__auto___12845 = t;
(o__12307__auto___12845["cljs$lang$ctorPrWriter"]).call(o__12307__auto___12845,t,writer);
}catch (e12561){var __12846 = e12561;
}
...
var char_code = (function (){var o__12307__auto__ = (new String(char$));
return (o__12307__auto__["charCodeAt"]).call(o__12307__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__12307__auto__ = String;
return (o__12307__auto__["fromCharCode"]).call(o__12307__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__12573 = num_code;
switch (G__12573) {
case (1):
return (185);
...
var o__12307__auto__ = String;
return (o__12307__auto__["fromCharCode"]).call(o__12307__auto__,superscript_code);
});
/**
...
}catch (e12585){var _e__12330__auto__ = e12585;
return false;
}})())){
...
var vec__12586 = devtools.munging.parse_fn_source(fn_source);
var name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12586,(0),null);
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__12622){
var vec__12623 = p__12622;
var ns_detector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12623,(0),null);
...
var G__12858 = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last(remaining_tokens)], null),name_tokens);
var G__12859 = cljs.core.butlast(remaining_tokens);
name_tokens = G__12858;
remaining_tokens = G__12859;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq12614){
var G__12615 = cljs.core.first(seq12614);
var seq12614__$1 = cljs.core.next(seq12614);
var self__5711__auto__ = this;
return self__5711__auto__.cljs$core$IFn$_invoke$arity$variadic(G__12615,seq12614__$1);
}));
...
var vec__12641 = cljs.core.split_with((function (p1__12639_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__12639_SHARP_,"arity");
}),tokens);
...
var vec__12656 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(remaining_tokens,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([detector], 0));
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12656,(0),null);
var name_and_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12656,(1),null);
if(cljs.core.empty_QMARK_(protocol_ns)){
var G__12864 = cljs.core.rest(remaining_tokens);
var G__12865 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(name_tokens,cljs.core.first(remaining_tokens));
remaining_tokens = G__12864;
name_tokens = G__12865;
continue;
} else {
...
var vec__12677 = devtools.munging.strip_arity(tokens);
var tokens__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12677,(0),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12677,(1),null);
var vec__12680 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(tokens__$1,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([effective_detector], 0));
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12680,(0),null);
var tokens__$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12680,(1),null);
var vec__12683 = devtools.munging.parse_protocol(tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12683,(0),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12683,(1),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12683,(2),null);
var protocol_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12683,(3),null);
...
var vec__12692 = result;
var munged_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12692,(0),null);
var munged_name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12692,(1),null);
var munged_protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12692,(2),null);
var munged_protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12692,(3),null);
var munged_protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12692,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12692,(5),null);
...
if(cljs.core.truth_(temp__5802__auto__)){
var vec__12696 = temp__5802__auto__;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12696,(0),null);
var args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12696,(1),null);
var vec__12699 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$1(munged_name);
...
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(cljs.core.take.cljs$core$IFn$_invoke$arity$2((2),fn_info),cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),(function (){var G__12712 = cljs.core.second(cljs.core.first(arities));
return (devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1 ? devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1(G__12712) : devtools.munging.parse_fn_info_deep.call(null,G__12712));
})()));
}
} else {
return fn_info;
...
var G__12881 = (arity + (1));
var G__12882 = (function (){var temp__5802__auto__ = devtools.munging.get_fn_fixed_arity(f,arity);
if(cljs.core.truth_(temp__5802__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__12731){
var vec__12732 = p__12731;
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12732,(0),null);
var arity_fn = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12732,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__12745_SHARP_){
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(arities,p1__12745_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.cljs$core$IFn$_invoke$arity$2(devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__12746_SHARP_){
return cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),p1__12746_SHARP_);
}),sorted_infos);
...
var args__5732__auto__ = [];
var len__5726__auto___12888 = arguments.length;
var i__5727__auto___12889 = (0);
while(true){
if((i__5727__auto___12889 < len__5726__auto___12888)){
args__5732__auto__.push((arguments[i__5727__auto___12889]));

var G__12890 = (i__5727__auto___12889 + (1));
i__5727__auto___12889 = G__12890;
continue;
} else {
}
break;
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__12752){
var vec__12753 = p__12752;
var humanize_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12753,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq12747){
var G__12748 = cljs.core.first(seq12747);
var seq12747__$1 = cljs.core.next(seq12747);
var self__5711__auto__ = this;
return self__5711__auto__.cljs$core$IFn$_invoke$arity$variadic(G__12748,seq12747__$1);
}));
...
var map__12785 = options;
var map__12785__$1 = cljs.core.__destructure_map(map__12785);
var include_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12785__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12785__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12785__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12785__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__12786 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$2(munged_name,ns_detector);
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12786,(0),null);
var fn_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12786,(1),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12786,(2),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12786,(3),null);
var protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12786,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12786,(5),null);
...
var o__12307__auto__ = f;
return (o__12307__auto__["getBasis"]).call(o__12307__auto__);
});
/**
...
}catch (e12797){var _e__12330__auto__ = e12797;
...
var G__12903 = (obj[cljs.core.first(path)]);
var G__12904 = cljs.core.rest(path);
obj = G__12903;
path = G__12904;
continue;
} else {
...
var _STAR_ = (function (accum,p__12828){
var vec__12829 = p__12828;
var bit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12829,(0),null);
var protocol = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12829,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__12832){
var vec__12833 = p__12832;
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12833,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12833,(1),null);
var selector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12833,(2),null);
...
var post_process = (function (p__12837){
var vec__12838 = p__12837;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12838,(0),null);
var matches__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12838,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__12836_SHARP_){
return (obj[cljs.core.first(p1__12836_SHARP_)]);
}),sorted_matches);
