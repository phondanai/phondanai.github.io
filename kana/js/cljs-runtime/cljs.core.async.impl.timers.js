...
var i_17908 = (self__.level + (1));
while(true){
if((i_17908 <= (new_level + (1)))){
(update[i_17908] = self__.header);

var G__17910 = (i_17908 + (1));
i_17908 = G__17910;
continue;
} else {
}
...
while(true){
if((i <= self__.level)){
var links_17913 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_17913[i]));
} else {
x__$2.forward.push((((i < links_17913.length))?(links_17913[i]):null));
}

if((i < links_17913.length)){
(links_17913[i] = x__$2);
} else {
links_17913.push(x__$2);
}
...
var i_17917 = (0);
while(true){
if((i_17917 <= self__.level)){
var links_17918 = (update[i_17917]).forward;
if((x__$1 === (((i_17917 < links_17918.length))?(links_17918[i_17917]):null))){
(links_17918[i_17917] = (x__$1.forward[i_17917]));

var G__17919 = (i_17917 + (1));
i_17917 = G__17919;
continue;
} else {
var G__17920 = (i_17917 + (1));
i_17917 = G__17920;
continue;
}
} else {
