...
var G__12905 = devtools.prefs.pref(v);
v = G__12905;
continue;
} else {
return v;
...
}catch (e12849){var _e__12330__auto__ = e12849;
return false;
}})();
...
}catch (e12854){var _e__12330__auto__ = e12854;
return false;
}})();
...
}catch (e12860){var _e__12330__auto__ = e12860;
return false;
}}
}
});
...
var vec__12878 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12878,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12878,(1),null);
...
return cljs.core.some((function (p1__12883_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__12883_SHARP_);
}),template);
});
