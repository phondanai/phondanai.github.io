...
args__5732__auto__.push((arguments[i__5727__auto___13015]));
...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq12909){
...
return self__5711__auto__.cljs$core$IFn$_invoke$arity$variadic(G__12910,G__12911,seq12909__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__12929_SHARP_){
return (!((cljs.core.meta(p1__12929_SHARP_) == null)));
})))){
...
var map__12955 = opts;
var map__12955__$1 = cljs.core.__destructure_map(map__12955);
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12955__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e12956){var _e__12330__auto__ = e12956;
return false;
}})();
if(cljs.core.truth_(or__5002__auto__)){
return or__5002__auto__;
...
}catch (e12962){var _e__12330__auto__ = e12962;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__12979 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__12980 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__12980);
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12987__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__12979);
}});
...
var temp__5802__auto___13047 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5802__auto___13047)){
var managed_print_level_13048 = temp__5802__auto___13047;
var _STAR_print_level_STAR__orig_val__13004_13049 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__13005_13050 = managed_print_level_13048;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__13005_13050);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__12995_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__12995_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__13004_13049);
}} else {
job_fn();
}
