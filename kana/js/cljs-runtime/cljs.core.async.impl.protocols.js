...
var cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_15695 = (function (port,fn1_handler){
...
return cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_15695(port,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_15696 = (function (port,val,fn1_handler){
var x__5350__auto__ = (((port == null))?null:port);
...
return cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_15696(port,val,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_15697 = (function (chan){
...
return cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_15697(chan);
}
});

var cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_15699 = (function (chan){
var x__5350__auto__ = (((chan == null))?null:chan);
...
return cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_15699(chan);
}
});
...
var cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_15702 = (function (h){
...
return cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_15702(h);
}
});

var cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_15703 = (function (h){
var x__5350__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_15703(h);
}
});

var cljs$core$async$impl$protocols$Handler$commit$dyn_15709 = (function (h){
var x__5350__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$commit$dyn_15709(h);
}
});
...
var cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_15712 = (function (b){
...
return cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_15712(b);
}
});

var cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_15714 = (function (b){
var x__5350__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_15714(b);
}
});

var cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_15717 = (function (b,itm){
var x__5350__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_15717(b,itm);
}
});

var cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_15720 = (function (b){
var x__5350__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_15720(b);
}
});
